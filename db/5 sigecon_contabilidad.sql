...
--
-- Host: 127.0.0.1:7733
-- Generation Time: Dec 05, 2020 at 02:15 AM
...
(16, 'Banco CUP', '0598712105645312', '922495987018', '1064', '110-1', '115.0000', '35.0000', 'Tarjeta en moneda nacional\n	- Se cobra la CUJAE', 10),
...
(30, 'Billetera MN', '101 - 1', '100.0000', '40.0000', 'Dinero que tengo arriba en la billetera', 17, 10, 28),
(31, 'Inversiones MN', '102 - 1', '0.0000', '50.0000', 'Dinero por concepto de inversiones', 17, 10, 28),
(32, 'Ingresos MN', '950 - 1', '0.0000', '264.0000', 'Cuenta de ingresos para cuadre', 14, 10, 28),
(33, 'Gastos MN', '865 - 1', '75.0000', '0.0000', 'Cuenta de gastos para cuadres', 15, 10, 28),
...
(37, 'Cuenta por cobrar MN', '340 - 1', '119.0000', '20.0000', '', 12, 10, 28),
(39, 'Billetera MLC', '101 - 2', '0.0000', '0.0000', 'aksdlasndlansdl\n__asdaa', 17, 12, 28),
...
(187, 'asd', 'asd', '2020-11-17', 'asdasd', 7, 17),
(188, '-', '74', '2020-11-06', '', 6, 18),
(189, 'zzzzzzzz', 'aaaa', '2020-11-06', '', 7, 19),
(190, 'asd', 'asd', '2020-11-06', '', 8, 18),
(192, '1', '1', '2020-11-08', '', 7, 20),
(193, '2', '2', '2020-11-08', '', 6, 19),
(196, '1', 'Pago de Datos', '2020-11-07', 'Dinero que se gasta por concepto de compra de un paquete de datos', 8, 14),
(197, '9999999999999', '9999999999999', '2021-03-20', '', 7, 20),
(198, '5011', '111', '2020-11-27', '', 6, 20);
...
(23, 'asd', 'asd', '100.0000', '0.0000', '2020-11-06', '', 16, 178),
(27, 'asdfgh', 'asdfg', '15.0000', '0.0000', '2020-11-07', '', 16, 176),
(28, 'zzzzzzzz', 'aaaa', '0.0000', '35.0000', '2020-11-07', '', 16, 177);
...
(358, '50.0000', '0.0000', 30, 187),
(359, '0.0000', '50.0000', 32, 187),
(360, '0.0000', '15.0000', 32, 188),
(361, '15.0000', '0.0000', 37, 188),
(362, '0.0000', '35.0000', 41, 189),
(363, '35.0000', '0.0000', 33, 189),
(364, '0.0000', '100.0000', 32, 190),
(365, '100.0000', '0.0000', 37, 190),
(368, '0.0000', '20.0000', 30, 192),
(369, '20.0000', '0.0000', 37, 192),
(370, '20.0000', '0.0000', 33, 193),
(371, '0.0000', '20.0000', 37, 193),
(376, '0.0000', '20.0000', 30, 196),
(377, '20.0000', '0.0000', 33, 196),
(378, '99.0000', '0.0000', 37, 197),
(379, '0.0000', '99.0000', 32, 197),
(380, '0.0000', '50.0000', 31, 198),
(381, '50.0000', '0.0000', 30, 198);
...
--
ALTER TABLE `cuadre`
  MODIFY `id_cuadre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
...
--
ALTER TABLE `info_operacion_contable`
  MODIFY `id_info_operacion_contable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;

--
-- AUTO_INCREMENT for table `liquidacion`
--
ALTER TABLE `liquidacion`
  MODIFY `id_liquidacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `operacion_contable`
  MODIFY `id_operacion_contable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=382;
...
--
ALTER TABLE `tipo_operacion_contable`
  MODIFY `id_tipo_operacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
