...
--
-- Host: 127.0.0.1:7733
-- Generation Time: Aug 14, 2020 at 06:56 AM
...
CREATE TABLE `ajuste` (
  ...
  `operacion_contable_ajustar_fk` int(11) NOT NULL,
  `operacion_contable_ajuste_fk` int(11) NOT NULL,
...
ALTER TABLE `ajuste`
  ...
  ADD UNIQUE KEY `UNIQUE_ajustar_ajustada` (`operacion_contable_ajustar_fk`,`operacion_contable_ajuste_fk`),
  ADD KEY `FK_ajuste_ajustada` (`operacion_contable_ajuste_fk`);
...
ALTER TABLE `liquidacion`
  ...
  ADD KEY `FK_liquidacion_ajuste` (`ajuste_fk`);
...
--
ALTER TABLE `ajuste`
  ADD CONSTRAINT `FK_ajuste_ajustada` FOREIGN KEY (`operacion_contable_ajuste_fk`) REFERENCES `operacion_contable` (`id_operacion_contable`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_ajuste_ajuste` FOREIGN KEY (`operacion_contable_ajustar_fk`) REFERENCES `operacion_contable` (`id_operacion_contable`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `liquidacion`
  ADD CONSTRAINT `FK_liquidacion_ajuste` FOREIGN KEY (`ajuste_fk`) REFERENCES `ajuste` (`id_ajuste`) ON DELETE CASCADE ON UPDATE CASCADE,
