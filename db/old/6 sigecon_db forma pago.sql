...
--
-- Host: 127.0.0.1:7733
-- Generation Time: Aug 17, 2020 at 11:23 PM
...
INSERT INTO `cuadre` (`id_cuadre`, `operacion_contable_fk`, `operacion_contable_cuadre_fk`, `liquidada`, `descripcion`) VALUES
(1, 1, 2, 1, '');
...
(1, 'Banco CUP', '1111111111111111', '1111111111111111', '1111', '110', 100, 0, '', 3),
...
INSERT INTO `cuenta_contable` (`id_cuenta_contable`, `nombre_cuenta`, `codigo`, `debito`, `credito`, `descripcion`, `tipo_cuenta_fk`, `moneda_fk`) VALUES
(1, 'Gasto CUP', '823', 0, 0, '', 1, 3),
(2, 'Ingresos CUP', '920', 0, 100, '', 2, 3),
(3, 'Cuenta por Cobrar CUP', '340', 0, 0, '', 4, 3),
(4, 'Cuentas por Pagar CUP', '406', 0, 0, '', 3, 3),
(8, 'Por pagar', '407', 0, 0, '', 3, 4);
...
(2, '00001123', 'asd', '2020-08-19', '', 2, 3, 0);
...
(11, '00001123', 'asd', 100, 0, '2020-08-17', '', 1, 1);
...
(3, 'Compra', 'key', ''),
(4, 'Movimiento interno', 'tipo_operacion_contable.key.movimiento_interno', 'Cuando se mueven activos internamente, sin estar relacionados con ninguna actividad especifica');
...
ALTER TABLE `cuadre`
  ...
  ADD UNIQUE KEY `UNIQUE_ajustar_ajustada` (`operacion_contable_fk`,`operacion_contable_cuadre_fk`),
  ADD KEY `FK_cuadre_operacion` (`operacion_contable_cuadre_fk`);
...
--
ALTER TABLE `cuadre`
  MODIFY `id_cuadre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `cuenta_contable`
  MODIFY `id_cuenta_contable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `info_operacion_contable`
  MODIFY `id_info_operacion_contable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `liquidacion`
--
ALTER TABLE `liquidacion`
  MODIFY `id_liquidacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `operacion_contable`
  MODIFY `id_operacion_contable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
