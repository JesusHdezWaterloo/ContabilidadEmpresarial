...
public class CuentaContable implements Serializable {
    ...
    public CuentaContable(Integer idCuentaContable, String nombreCuenta, String codigo, double debito, double credito, Date fecha, String descripcion, TipoCuenta tipoCuentaFk, Moneda monedaFk) {
        this.idCuentaContable = idCuentaContable;
    ...
    public String toString() {
        return "com.jhw.gestion.modules.contabilidad.repo.entities.CuentaContable[ idCuentaContable=" + idCuentaContable + " ]";
    }
